...
```{r}
#I would use the mutate function in tidyverse to check if the state names were correct.Then I would match sure all the state names match by putting them in all uppercase or all lower case. Thatway when i group the data it will all match soican combine rows that are the same state. 
