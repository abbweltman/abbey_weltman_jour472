...
workflow for any data analysis project in install.packages("rio")R. You will learn to import
...
```{r}
#The Median Salary for NTY employees is 51500
...
```{r}
#the highest paid position is a news Assistant with a salary of $65,000 and it is a POC cis female
```
...
```{r}
#The Median Salary for Bloombery is 50,000 that is 15,000 less than NYT. However the Highest salary is signifigantly higher than NYT. 
