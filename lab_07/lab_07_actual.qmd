...
## Load data
```{r setup, echo=FALSE}
arcos <- read_csv("~/Documents/GitHub/abbey_weltman_jour472/lab_07/data/arcos.csv")
county_population_2014 <- read_csv("~/Documents/GitHub/abbey_weltman_jour472/lab_07/data/county_population_2014.csv")
state_crosswalk <- read_csv("~/Documents/GitHub/abbey_weltman_jour472/lab_07/data/state_crosswalk.csv")
state_population_2014 <- read_csv("~/Documents/GitHub/abbey_weltman_jour472/lab_07/data/state_population_2014.csv")
...
#Norton City total pills: 10555170
...
five_highest <- acros_combo %>%
select(total_pills_2006, total_pills_2014, state_name) %>%
mutate(percentage_change =((total_pills_2014 - total_pills_2006 )/ total_pills_2006 )) %>%
slice_max(percentage_change, n=5)

five_lowest <- acros_combo %>%
select(total_pills_2006, total_pills_2014, state_name) %>%
mutate(percentage_change =((total_pills_2014 - total_pills_2006 )/ total_pills_2006 )) %>%
