...
In this notebook I will look into the dynamics of business development in Baltimore, Maryland. By examining datasets related to the distribution of new businesses across different regions of Baltimore, we aim to uncover insights into the patterns and trends of entrepreneurial activity within the city.
...
#balt_shape <- balt_tract_shapefiles %>%
 # 
#Census_Tract_2020_sf <- Census_Tract_2020 %>%
#st_as_sf()
#inner_join (Census_Tract_2020, balt_tract_shapefiles, by=c("geoid" ="GEOID_Tract_2020"))
#st_join(balt_tract_shapefiles, Census_Tract_2020, join = st_intersects))

#ggplot() +
  #geom_sf(data = balt_tract_shapefiles) +
