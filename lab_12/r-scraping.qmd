...
```{r}
#How does the median household income in each county correlate with the percentage of votes received by each candidate in the Republican primary election?

#Is there a relationship between the educational attainment levels of each county and the distribution of votes among the candidates in the primary election?
