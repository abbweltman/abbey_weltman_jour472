...
pg_elementary_school_locations <- readRDS("~/Documents/GitHub/data_journalism_class/04_labs/lab_09/assets/pg_elementary_school_locations.rds")
...
```{r}
pg_county <- readRDS("~/Documents/GitHub/data_journalism_class/04_labs/lab_09/assets/pg_county.rds")
...
```{r}
attendance <- readRDS("~/Documents/GitHub/data_journalism_class/04_labs/lab_09/assets/attendance.rds")
...
pg_tract_income <- readRDS("~/Documents/GitHub/data_journalism_class/04_labs/lab_09/assets/pg_tract_income.rds")
...
1. You could use a spatial join to determine if you want to see the demographics in an area. I could ask, what are the demographics of the population living within near shopping mall? I would use a ggplot to represent Shopping mall locations as points. Then I would take the demographic data such as population density and age to represent as. I would use the gg plot and the Sf function to create a plot with a scale to show what demographics are predominately in that area 

2. I could also use a spatial join to determine questions about Urban planning, I could determine How many parks are within a 1-mile radius of each residential neighborhood in a city? For this question, you would need two geographic dataframes including residential neighborhoods outlines representing boundaries of different neighborhoods and 
Parks points representing the locations of all the parks within the city. I would use the leaflet for this. 
