...
join_pct <- inner_join(male, total_pop_2020, by = c( "NAME" = "state" )) %>%
   mutate(pct_whole = (estimate / total_population) *100 )%>%
  arrange(desc(pct_whole))
    
#Alaska has the largest percent of males in the states population. It was 52.45% of the total population.
```
